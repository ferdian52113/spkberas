...
<html lang="en" >
    ...
    <head>
        ...
        <!--end::Base Styles -->
        <link rel="shortcut icon" href="<?php echo base_url()?>assets/logo beras.png" />
    </head>
    <!-- end::Head -->
    <!-- begin::Body -->
                            ...
                            <div class="m-stack m-stack--ver m-stack--general">
                                <div class="m-stack__item m-stack__item--middle m-stack__item--center m-brand__logo">
                                    <a href="<?php echo base_url()?>" class="m-brand__logo-wrapper">
                                        <img alt="" style="width:66px;height:44px" src="<?php echo base_url()?>assets/logo beras.png"/>
                                    </a>
                                </div>
                                    ...
                                    <ul class="m-topbar__nav m-nav m-nav--inline">
                                        <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" data-dropdown-toggle="click">
                                            <a href="#" class="m-nav__link m-dropdown__toggle">    
                                                ...
                                                <span class="m-topbar__username"><?php echo $this->session->userdata('lembaga')?></span>
                                                        ...
                                                        <div class="m-dropdown__content">
                                                            <ul class="m-nav m-nav--skin-light">
                                                                ...
                                                                <li class="m-nav__item">
                                                                    <a href="<?php echo base_url()?>user/logout" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">
                                                                        Logout
                                                                    </a>
                                                                </li>
                                                            </ul>
